...
const JobDetails = () => {
  ...
  return (
    <div className="min-h-screen w-full p-9  bg-light_gray font-sans">
      {/* Main Card */}
      <div className="  bg-veryLight_purple  h-[860px] rounded-[40px] overflow-hidden shadow-lg">
        <div className=" px-6 py-6 ">
          ...
          <div className="company-info mt-6">
            ...
            <div>
              ...
              <div className="text-xs text-dark_gray capitalize flex flex-row items-center justify-start gap-1 !text-base">
        ...
        <div className="flex justify-center bg-white pt-8">
          {["description", "requirements", "company"].map((key) => (
            <button
              key={key}
              className={`py-2 px-4 w-[437px] h-[56px] ${
                tab === key
