...
const Aside_profile = () => {
  return (
    <>
      <Link
        to="/companyProfile"
        className="w-[330px] flex flex-col justify-start gap-5 bg-light_gray"
      >
        <div className="profile_box flex items-center justify-evenly flex-col bg-white  w-full h-[229px] p-5 pt-0 rounded-xl">
          ...
          <Link
            to="/EditCompanyInfo"
            className="text-white bg-primry_purble text-sm h-[40px] w-[165px] flex items-center justify-center rounded-[20px] font-bold text-base"
          >
            update profile
          </Link>
        </div>
