        ...
        >
            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        className={`text-dark_gray text-base font-normal w-full border pl-4 p-2 rounded-[18px] h-14 ${errors.jobTitle ? "border-red-500" : "border-light_gray"
                            }`}
                    />
                    {errors.jobTitle && (
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            className={`text-dark_gray text-base font-normal w-full border p-2 pl-12 rounded-[18px] h-14 ${errors.jobLevel ? "border-red-500" : "border-light_gray"
                                }`}
                        >
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            className={`text-dark_gray text-base font-normal w-full border p-2 pl-12 rounded-[18px] h-14 ${errors.jobType ? "border-red-500" : "border-light_gray"
                                }`}
                        >
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            className={`text-dark_gray text-base font-normal w-full border p-2 pl-12 rounded-[18px] h-14 ${errors.workingmodel ? "border-red-500" : "border-light_gray"
                                }`}
                        >
                            <option value="">Select one</option>
            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className={`text-dark_gray text-base font-normal w-full border pl-4 resize-none p-2 rounded-[18px] h-[186px] ${errors.description ? "border-red-500" : "border-light_gray"
                            }`}
                    />
                    {errors.description && (
                ...
                <div>
                    ...
                    <textarea
                        ...
                        onChange={handleChange}
                        placeholder="Type here..."
                        className={`text-dark_gray text-base font-normal w-full border pl-4 resize-none p-2 rounded-[18px] h-[186px] ${errors.requirements ? "border-red-500" : "border-light_gray"
                            }`}
                    />
                    {errors.requirements && (
                ...
                <div>
                    ...
                    <textarea
                        ...
                        onChange={handleChange}
                        placeholder="Type here..."
                        className={`text-dark_gray text-base font-normal w-full border pl-4 resize-none p-2 rounded-[18px] h-[186px] ${errors.AboutCompany ? "border-red-500" : "border-light_gray"
                            }`}
                    />
                    {errors.AboutCompany && (
            ...
            <div>
                ...
                <input
                    ...
                    className={`text-dark_gray text-base font-normal w-full border pl-4 p-2 rounded-[18px] h-14 ${errors.personName ? "border-red-500" : "border-light_gray"
                        }`}
                />
                {errors.personName && (
            ...
            <div>
                ...
                <PhoneInput
                    ...
                    inputClass={`text-dark_gray text-base font-normal !w-full !h-14 !rounded-[18px] ${errors.phoneNumber ? "border-red-500" : "border-light_gray"
                        }`}
